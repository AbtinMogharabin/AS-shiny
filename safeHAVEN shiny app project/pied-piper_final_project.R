...
ui <- fluidPage(
  ...
  navbarPage("safeHAVEN", theme = shinytheme("flatly"),
                                 ...
                                 fluidRow(
                                   ...
                                   column(6,
                                          ...
                                          h4(h4(p("ABOUT THE TEAM")),
                                             ...
                                             p("Abtin Mogharabin"),
                                             p("Abdul Samad Najm"),
                                             p("Saad Al Bayzid Chowdhury"),
                                             p("Ali Muhammad Lalani"),
                                             p("Muhammad Hashim Usman")
             ...
             tabPanel('Model Analysis', icon=icon("external-link-square"),
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          fluidRow(
                            column(3,actionButton(inputId = 'go', label = "Predict!",icon = icon("play"), class = "btn btn-primary", align = "center"))
                          ),
                      ...
                      fluidRow(
                        column(8,
                               ...
                               h5(p("Do refugees and Venezuelans displaced abroad lived in countries neighbouring their countries of origin?"),
                                  ...
                                  br(),
                                  br(),
                                  h5(p("I hope you find our shiny app useful.  Any comments or questions are welcome at atbinmogharabin@gmail.com"),
                                     p("The source code for this Shiny app is available ", a("here", href = "https://github.com/abtinmogharabin"), "."))
...
server <- function(input, output) {
  ...
  ####### Developed by: Saad Al Bayzid Chowdhury and Abtin Mogharabin  #######  
  ############################################################################
  ############################################################################  
  ############################################################################
  ...
  ############################################################################  
  ##########                   Location Finder Panel                 #########
  ########## Developed by: Abtin Mogharabin and  Ali Muhammad Lalani #########  
  ############################################################################
  ############################################################################  
  ############################################################################
